      ...
      <div className="flex flex-row items-center justify-center space-x-8 w-full max-w-4xl">
        ...
        <div className="w-1/2 flex justify-center">
          <div className="text-rectangle p-4 bg-lightest">
            ...
            <p className="text-lg">
              Here is a brief introduction about myself. I am a passionate developer with skills in various technologies including React, Node.js,Next.js and more. I enjoy building visually appealing and highly functional web applications
            </p>
          </div>
        </div>
      </div>
